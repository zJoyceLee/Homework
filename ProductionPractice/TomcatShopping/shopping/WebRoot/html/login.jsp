	...
	<div id="page-wrapper">
		...
		<div class="banner" id="home">
			<div class="banner-right">
				<h1 class="wow zoomIn animated" data-wow-delay=".5s"><a href="index.html">welcome</a></h1>
			</div>
			<div class="banner-left">
				...
				<div class="banner-text">
					...
					<br>
					<h3 class="title wow fadeInLeftBig animated" data-wow-delay=".5s">欢迎您尊贵的会员!<br>
					<table class="welcome">
					<td><%=user.getUsername()%></td>
					</h3>
					<td>
							<h5><div class="contact-form">
							<form action="http://localhost:8080/shopping/html/logout.jsp" method="post">
