...
<%@ page language="java" import="dataBase.Mysql"%>
<style type="text/css">
body {padding: 150px;}
</style>
...
%>
	<div class="blog-left1 wow fadeInDownBig animated" data-wow-delay=".5s">
		...
		<div class="contact-form">
			<form action="http://localhost:8080/shopping/html/changeInfo.jsp" method="post">
				<table class="table table-striped" width="100">
					...
					<tr>
								...
								<td>&nbsp;</td>
								<td><h1>电&nbsp;话：</h1></td>
								<td><h1><%=sql.getPhone(user.getUsername())%></h1></td>
					...
					<tr>
								...
								<td>&nbsp;</td>
								<td><h1>地&nbsp;址：</h1></td>
								<td><h1><%=sql.getAddr(user.getUsername())%></h1></td>
					...
					<tr>
								...
								<td>&nbsp;</td>
								<td><h1>邮&nbsp;箱：</h1></td>
								<td><h1><%=sql.getEmail(user.getUsername())%></h1></td>
					...
					<tr>
								...
								<td>&nbsp;</td>
								<td>&nbsp;</td>
								<td><h4><input type="submit" value="修改信息" ></h4></td>
